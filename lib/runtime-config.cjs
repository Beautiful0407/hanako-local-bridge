...
const OFFICIAL_CLOUD_URL = "wss://154-201-69-202.sslip.io/local-bridge/connect";
const LEGACY_CLOUD_URL = "ws://154.201.69.202/local-bridge/connect";
...
function loadRuntimeConfig(options = {}) {
  ...
  if (!isObject(source.cloud)) {
    ...
    if (server && server !== "154.201.69.202") {
