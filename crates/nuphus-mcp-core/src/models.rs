...
use nuphus_desktop_api::vision::models::{
...
async fn download_file_inner(
    ...
    if file_name.ends_with(".onnx") {
        ...
        tokio::task::spawn_blocking(move || {
            nuphus_desktop_api::vision::paddle_ocr::onnx_session_loadable(&tmp_owned)
        })
        .await
...
mod tests {
    ...
    fn unknown_file_has_no_source() {
        ...
        assert_eq!(
            nuphus_desktop_api::vision::models::YOLO_MODEL,
            "icon_detect.onnx"
        );
    }
    ...
    fn size_floor_covers_known_models() {
        ...
        assert!(
            min_expected_bytes(nuphus_desktop_api::vision::models::YOLO_MODEL) > 0,
